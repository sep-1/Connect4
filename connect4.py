"""
Description: A connect 4 program that allows that allows two players to play a game of connect 4 against each other. 
Each player moves with different keys which are outlined in the game's how to play section and game experience.
"""
import pygame
import os
pygame.init()
